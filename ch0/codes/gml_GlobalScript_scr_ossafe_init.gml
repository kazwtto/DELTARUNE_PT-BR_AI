...
function scr_get_app_title(arg0)
{
    ...
    if (scr_is_demo_title(arg0))
    {
        if (scr_is_switch_os())
        {
            if (arg0.app_id == "n/a")
            {
                product_title = "DELTARUNE Capítulo 1&2\n";
            ...
            {
                product_title = "DELTARUNE Capítulo 1&2 Demo\n";
...
function scr_get_app_title_choice_text(arg0)
{
    ...
    if (scr_is_demo_title(arg0))
    {
        if (scr_is_switch_os())
        {
            if (arg0.app_id == "n/a")
            {
                product_title = "DELTARUNE Capítulo 1&2 [2021 demo]";
                
                if (global.lang == "ja")
                    product_title = "『DELTARUNE Capítulo 1&2』（2021年）";
            }
            else if (arg0.app_id == "n/a")
            {
                product_title = "DELTARUNE Capítulo 1&2 Demo [2025 demo]";
                
                if (global.lang == "ja")
                    product_title = "『DELTARUNE Capítulo 1&2 体験版』（2025年）";
            }
        }
        else
        {
