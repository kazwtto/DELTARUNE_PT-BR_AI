...
{
    var start_text = (global.lang == "en") ? "Gostaria de começar do Capítulo 1?" : "Chapter 1から始めますか？";
    var yes_text = (global.lang == "en") ? "Sim" : "はい";
    var no_text = (global.lang == "en") ? "Não" : "いいえ";
...
{
    var continue_text = (global.lang == "en") ? ("Continuar do Capítulo " + string(_chapter_in_progress) + "?") : ("Capítulo " + string(_chapter_in_progress) + "から続けますか？");
    var yes_text = (global.lang == "en") ? "Sim" : "はい";
    var no_text = (global.lang == "en") ? "Não" : "いいえ";
    var choices = [new create_choice(yes_text, UnknownEnum.Value_0), new create_choice(no_text, UnknownEnum.Value_1)];
    var choice_offset = (global.lang == "ja") ? -20 : 0;
...
{
    var continue_text = (global.lang == "en") ? ("Capítulo " + string(_chapter_completed) + " foi completo.") : ("Capítulo " + string(_chapter_completed) + "はクリア済みです。");
    var play_next_text = (global.lang == "en") ? ("Jogar Capítulo " + string(_chapter_completed + 1)) : ("Capítulo " + string(_chapter_completed + 1) + "をプレイ");
    var chapter_select_text = (global.lang == "en") ? "Selecionar Capítulo" : "チャプター選択";
...
{
    var load_text = (global.lang == "en") ? (scr_get_app_title(arg0) + "Dados de salvamento encontrados.\nImportar este salvamento?\n(Isto será perguntado apenas uma vez.)") : (scr_get_app_title(arg0) + "セーブデータを検出しました。\nこのセーブデータを取り込みますか？\n（この確認は一度しか行いません）");
    var yes_text = (global.lang == "en") ? "Sim" : "はい";
    var no_text = (global.lang == "en") ? "Não" : "いいえ";
    var choices = [new create_choice(yes_text, UnknownEnum.Value_0), new create_choice(no_text, UnknownEnum.Value_1)];
    var choice_offset = (global.lang == "ja") ? -20 : 0;
...
{
    var load_text = (global.lang == "en") ? "Múltiplos arquivos de salvamento do DELTARUNE encontrados.\nGostaria de importar um deles?\n(Isto será perguntado apenas uma vez.)\n \n " : "複数の『DELTARUNE』セーブデータが存在します。\nどれか1つを取り込みますか？\n（この確認は一度しか行いません）\n \n ";
    var choices = [];
    ...
    var do_not_text = (global.lang == "en") ? "Não importar" : "取り込まない";
...
{
    var deny_text = (global.lang == "en") ? "Prosseguir sem importar?" : "取り込まずに進めますか？";
    var yes_text = (global.lang == "en") ? "Sim" : "はい";
    var no_text = (global.lang == "en") ? "Não" : "いいえ";
    var choices = [new create_choice(yes_text, UnknownEnum.Value_0), new create_choice(no_text, UnknownEnum.Value_1)];
    var choice_offset = (global.lang == "ja") ? -20 : 0;
